export const siteContent = {
  ...
  aboutPreview: {
    ...
    bullets: [
      ...
      "Traditional costumes & authentic instruments",
      "Storytelling through movement",
    ],
    closing: "Here, performances are not composed for spotlight — they are choreographed to keep the legacy alive.",
  ...
  media: [
    ...
    { id: 2, title: "Grand Premiere at Jaipur Lit Fest", date: "Feb 2024", outlet: "Performance" },
  ],
  footer: {
    contact: {
